...
public class AccountInfoServiceImpl implements AccountInfoService {
    ...
    public AccountInfoServiceImpl(CustomerRepository customerRepository,BranchRepository branchRepository,AccountInfoRepository accountInfoRepository, ModelMapper modelMapper, HikariDataSource dataSource){
...
//    		 
	...
	public Response get(Long id) {
        ...
        if(accountInfo != null){
            ...
            if(accountInfo != null){
                return ResponseBuilder.getSuccessResponse(HttpStatus.OK, root+" retrieved Successfully", accountInfoDto);
            }
            return ResponseBuilder.getFailureResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Internal Server Error Occurs");
        }
        return ResponseBuilder.getFailureResponse(HttpStatus.NOT_FOUND, root+" not found");
